@extends('layouts.app' , ['title' => "User Dashboard" , "activePage" => "dashboard" , "pageType" => "auth"])
@section('content')
                    ...
                    <div class="col-xl-8 stretch-card grid-margin">
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <a class="text-black d-block pl-4 pt-2 pb-2 pb-lg-0 font-13 font-weight-bold" href="#">Show
                                    more</a>
                            </div>
                        </div>
                    </div>

            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 filtr-item">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/destination1.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 filtr-item">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/destination2.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-6 m-auto">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/destination3.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/offer1.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                            <div class="review">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/offer2.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                            <div class="review">
                                <i class='bx bxs-star'></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/offer3.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                            <div class="review">
                                <i class='bx bxs-star'></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/offer4.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                            <div class="review">
                                <i class='bx bxs-star'></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/offer5.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                            <div class="review">
                                <i class='bx bxs-star'></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item-single mb-30">
                        <div class="image">
                            <img src="{{ $web_source }}/img/offer6.jpg" alt="Demo Image">
                        </div>
                        <div class="content">
                            <div class="review">
                                <i class='bx bxs-star'></i>

...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{asset('dashboard')}}/index.html">ADMINBSB - MATERIAL DESIGN</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{asset('dashboard')}}/images/user.png" width="48" height="48" alt="User" />
                </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{asset('dashboard')}}/index.html">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{asset('dashboard')}}/pages/maps/google.html">Sub Admins</a>
                            </li>
                            <li>
                                <a href="{{asset('dashboard')}}/pages/maps/yandex.html">Agents</a>
                            </li>
                            <li>
                                <a href="{{asset('dashboard')}}/pages/maps/jvectormap.html">Users</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{asset('dashboard')}}/pages/maps/google.html">Debits</a>
                            </li>
                            <li>
                                <a href="{{asset('dashboard')}}/pages/maps/yandex.html">Credits</a>
                            </li>
                        </ul>
                    </li>
